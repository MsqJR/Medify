...
import PharmacyTemplate2ServicesPage from '@/app/templates/pharmacy/2/services/page'
import PharmacyTemplate5ServicesPage from '@/app/templates/pharmacy/5/services/page'
...
export default async function SubdomainServicesPage({ params }: PageProps) {
  ...
  const renderPage = () => {
    switch (subdomainInfo.template_id) {
      case 2: return <PharmacyTemplate2ServicesPage />
      case 5: return <PharmacyTemplate5ServicesPage />
      default: notFound()
    }
  }
